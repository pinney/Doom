...
CFLAGS=-g -DMORELIGHTLEVELS -DPADDED_STRUCTS -DNORMALUNIX -DHAVE_ALLOCA
...
OBJS=		am_map.o i_sound.o i_video.o dh_stuff.o doomdef.o doomstat.o \
		dstrings.o d_items.o d_main.o d_net.o f_finale.o f_wipe.o g_game.o hu_lib.o hu_stuff.o info.o \
		i_main.o i_net.o i_system.o m_argv.o m_bbox.o m_cheat.o m_fixed.o m_menu.o m_misc.o m_random.o \
...
all:		/usr/local/lib/Doom/xdoom

/usr/local/lib/Doom/xdoom:    $(OBJS)
